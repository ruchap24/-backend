...
var EducationService = function () {
    ...
    var _classThis;
    var EducationService = _classThis = /** @class */ (function () {
        function EducationService_1(prisma) {
            this.prisma = prisma;
        }
        EducationService_1.prototype.create = function (createEducationDto, userId) {
        ...
        EducationService_1.prototype.delete = function (educationId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var profile;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.prisma.education.delete({
                                    where: {
                                        id: educationId,
                                        profileId: profile.id,
                                    },
        ...
        return EducationService_1;
    }());
    __setFunctionName(_classThis, "EducationService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        EducationService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EducationService = _classThis;
}();
